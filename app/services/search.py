    ...
    *,
    ...
    rows = connection.execute(
        ...
        SELECT
            ...
            q.item_per_package,
            q.packages,
            q.weight_per_package,
            q.gross_weight,
            q.length,
            q.width,
            q.height,
            q.measurements_volume,
            q.packaging,
            q.expected_delivery,
            q.comment,
            q.updated_by,
            ...
            product["quotations"].append(
                {
                    ...
                    "item_per_package": row["item_per_package"],
                    "packages": row["packages"],
                    "weight_per_package": row["weight_per_package"],
                    "gross_weight": row["gross_weight"],
                    "length": row["length"],
                    "width": row["width"],
                    "height": row["height"],
                    "measurements_volume": row["measurements_volume"],
